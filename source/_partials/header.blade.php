        ...
        <div class="flex items-center justify-between flex-wrap p-6">
            <a href="/" class="flex items-center flex-no-shrink no-underline text-grey-darker">
                <div class="h-10 w-10 mr-3">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <defs>
                ...
                <h1 class="uppercase text-sm tracking-wide font-normal">Built with Jigsaw
                </h1>
            </a>
